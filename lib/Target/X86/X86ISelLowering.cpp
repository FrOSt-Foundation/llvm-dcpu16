...
X86TargetLowering::emitEHSjLjSetJmp(MachineInstr *MI,
  ...
  unsigned LabelReg = 0;
  const int64_t LabelOffset = 1 * PVT.getStoreSize(getTargetMachine().getDataLayout()->getBitsPerByte());
...
X86TargetLowering::emitEHSjLjLongJmp(MachineInstr *MI,
  ...
  const int64_t LabelOffset = 1 * PVT.getStoreSize(getTargetMachine().getDataLayout()->getBitsPerByte());
  const int64_t SPOffset = 2 * PVT.getStoreSize(getTargetMachine().getDataLayout()->getBitsPerByte());
